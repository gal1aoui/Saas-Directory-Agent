...
class BrowserAutomation:
    ...
    async def fill_and_submit_form(
        ...
        try:
            ...
            timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
            pre_submit_screenshot = f"{self.settings.UPLOAD_DIR}/screenshots/pre_submit_{timestamp}.png"
            ...
            post_submit_screenshot = f"{self.settings.UPLOAD_DIR}/screenshots/post_submit_{timestamp}.png"
